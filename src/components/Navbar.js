...
export default function Navbar(props) {
    return (
      <nav className="navbar navbar-expand-lg" style={{backgroundColor: '#444141'}}>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex" role="search">              
                ...
                <button type="button left" class="btn btn-primary" onClick={props.toggleBlueMode} id="BlueSwitch">Enable Blue Mode</button>
